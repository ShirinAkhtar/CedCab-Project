...
<nav class="navbar navbar-inverse nav-pills flex-column flex-sm-row navbar-expand-md">
  ...
  <header><h2>Welcome <?php echo $_SESSION['userdata']['dataname']; ?></h2></header>
<section>
  <nav>
    <ul>
  ...
  <article>
  <ul>
      <li>User Id:-  <?php echo $_SESSION['userdata']['userid']; ?></li>
      <li>Your Username:- <?php echo $_SESSION['userdata']['username']; ?></li>
      <li>Your Name:- <?php echo $_SESSION['userdata']['dataname']; ?></li>
      <li>Your Mobile Number:- <?php echo $_SESSION['userdata']['datamobile']; ?></li>
    </ul> </article>
</section>
<footer>
  <p>@Cedcab</p>
